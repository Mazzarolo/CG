...
EnemiesManager::EnemiesManager(int screenWidth, int screenHeight, Background* background, Player* player)
{
    ...
    sprites[0]->load((char*) "Trab3JoaoMazzarolo\\src\\Images\\Enemies\\Enemy0.bmp");

    sprites.push_back(new Animation(2, 1, 2, 0.3f));
    sprites[1]->load((char*) "Trab3JoaoMazzarolo\\src\\Images\\Enemies\\Enemy1.bmp");

    sprites.push_back(new Animation(2, 1, 2, 0.3f));
    sprites[2]->load((char*) "Trab3JoaoMazzarolo\\src\\Images\\Enemies\\Enemy2.bmp");
