...
SceneManager::SceneManager(int screenWidth, int screenHeight)
{
    ...
    clock = new Clock();
    PlaySound(TEXT("Trab3JoaoMazzarolo\\src\\Sounds\\MenuMusic.wav"), NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
...
void SceneManager::update()
{
    ...
    {
        PlaySound(TEXT("Trab3JoaoMazzarolo\\src\\Sounds\\GameOverMusic.wav"), NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
        currentScene->setNextScene(-1);
